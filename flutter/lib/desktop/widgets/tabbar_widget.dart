...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (jetXcelDeskWinManager.getActiveWindows().contains(kMainWindowId)) {
        await jetXcelDeskWinManager.unregisterActiveWindow(kMainWindowId);
      }
...
class AddButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ActionIcon(
        ...
        icon: IconFont.add,
        onTap: () => jetXcelDeskWinManager.call(
