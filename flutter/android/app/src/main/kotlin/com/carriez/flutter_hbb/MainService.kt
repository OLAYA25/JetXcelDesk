...
const val DEFAULT_NOTIFY_TITLE = "JetXcelDesk"
...
class MainService : Service() {
    ...
    private val wakeLock: PowerManager.WakeLock by lazy { powerManager.newWakeLock(PowerManager.ACQUIRE_CAUSES_WAKEUP or PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "jetxceldesk:wakelock")}
    ...
    fun stopCapture() {
        ...
        // https://github.com/OLAYA25/JetXcelDesk/issues/4118#issuecomment-1515666629
        imageReader?.close()
        imageReader = null
        videoEncoder?.let {
    ...
    private fun initNotification() {
        ...
        notificationChannel = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "JetXcelDesk"
            val channelName = "JetXcelDesk Service"
            val channel = NotificationChannel(
                channelId,
                channelName, NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "JetXcelDesk Service Channel"
            }
