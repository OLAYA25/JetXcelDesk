...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("jetxceldesk".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../jetxceldesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\jetxceldesk\flutter\build\windows\runner\Debug\ -o . -e ..\jetxceldesk\flutter\build\windows\runner\Debug\jetxceldesk.exe
